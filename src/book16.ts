...
export const book16Chapters: Chapter[] = [
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what naming both sides accomplishes", body: "Naming the authorities on each side, rather than describing an anonymous disagreement, forecloses the easiest way out of the question. If the split were between the serious and the lax, a reader could settle it by deciding which sort he intended to be. It is not: Sufyan al-Thawri is on one side and men of comparable standing on the other, and no reader of the Ihya is in a position to conclude that either group had simply not thought about it." },
      { title: "See what he does with the weak argument", body: "And it is worth catching that he marks one of the arguments for mixing as weak while arguing on that side himself later. The verse about God having joined their hearts is cited as counting the uniting cause a favour — and he says that is not what it means. An author assembling a case would have let it stand. Dismissing an argument that supports the position he is going to reach is the first sign that this chapter is a weighing rather than a defence." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what borrowing the method commits him to", body: "Announcing that this will go the way the marriage question went is a substantial commitment, because of how that one went: no general verdict, two worked cases coming out on opposite sides, and the deciding fact located in the person rather than in the institution. Applied here it means the chapter cannot end by recommending solitude or company, and any reader looking for a verdict is being told at the outset that he will have to produce it himself." },
      { title: "See what the sorting of benefits does", body: "And the sorting is more than tidiness. The religious benefits split into what solitude makes possible and what it protects against — capacity on one side, safety on the other. That distinction matters because the two are answerable in different ways: a benefit of capacity can sometimes be got another way, and a benefit of protection depends entirely on what a particular person is exposed to. The list is being built so that a reader can tell which items are actually his." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what kind of benefit the first is", body: "The first benefit does not remove any danger, which is what distinguishes it from the four that follow. It creates room — freedom for worship and for thought, and intimacy found in converse with God rather than with people. That is a benefit of capacity, and it is the one that ties this book back to the Quarter of Worship, where the whole timetable was built on the claim that continuity of remembrance is what everything else depends on." },
      { title: "Take the concession about the tongue", body: "And the second benefit rests on an admission he makes without qualification: guarding against the faults of the tongue while mixing with people is a great matter, and none escapes them but the truthful. That is a considerable thing to concede in a chapter that will end up arguing for company, and it is what gives the case for seclusion its force. The danger is not exotic; it is the ordinary traffic of conversation, and it is running the whole time a person is among others." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what the third benefit is really about", body: "The third names a specific mechanism rather than trouble in general: being drawn into quarrels that were never yours. Disputes belong to places, and they reach a person because he is present, not because he took a side or had an interest. Which means the exposure is a function of location alone — and it is the one item on the list that a person cannot reduce by being careful, because nothing he does brings it about." },
      { title: "See what the fourth benefit counts as harm", body: "And the fourth is worth reading closely because two of the three injuries it names require no event at all. Backbiting is something done. But being thought ill of, and being expected of, happen without anybody acting — they are states other people are in, and they land on a person who has done nothing and may know nothing about it. Counting those as harms is an unusual move, and it is what the fifth benefit will develop into an argument." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note which half comes first", body: "The fifth is stated as two halves and the order is deliberate: people's greed for you is cut off, and then yours for them. Putting theirs first means the benefit is not primarily about being left in peace. It is that a two-way traffic in expectation stops — and expectation is the thing the previous benefit already identified as a harm requiring no event. Solitude ends the traffic in both directions at once, which no amount of good conduct in company would do." },
      { title: "Follow the argument about excuses", body: "And the observation about excuses is the sharpest thing in the section. Circumstances stop a person from doing some of what is expected of him; there are genuine reasons; and not every reason can be stated publicly. So the man is judged on what he failed to do, with the explanation unavailable — and the complaint takes the form of a comparison: he did it for so-and-so and not for me. That is a position nothing can be done about from inside, and it is produced by the expectations rather than by any failure." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Take the sixth benefit at face value", body: "The sixth is the one nobody would invent, and its bluntness is the point. Escaping the sight of tiresome and foolish people, and not having to put up with their manners — and then the phrase, that the sight of a tiresome person is the blinding affliction. There is no attempt to dress this as anything nobler than it is. It is irritation, named as irritation, in a list of religious benefits." },
      { title: "See how he connects it to the rest", body: "And the connection he draws is what makes it belong: all of that pulls toward the corruption of religion, and solitude is safety from it. Which is a real argument rather than an excuse. Sustained irritation does not stay contained — it produces contempt, then speech, then the faults of the tongue the second benefit was already about. The trivial complaint and the serious one turn out to be the same item at two stages, and including the trivial version is what makes the list honest about why people actually withdraw." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note why every benefit of mixing is a pair", body: "Look at how the seven are stated: teaching and learning, benefiting and being benefited, disciplining and being disciplined, giving intimacy and receiving it. Each is a pair, and that is not stylistic. A pair requires two people by definition, which means these are not merely harder in solitude — they are unavailable in it, in the way that a conversation is unavailable to one person. The harms of seclusion are stated as impossibilities rather than as difficulties." },
      { title: "Take the last two seriously", body: "And the final two are the ones that do not look like benefits at first. Habituating humility is not something a person receives from company; it is something company does to him, whether he wants it or not, by putting him among people who do not defer to him. And gaining experience by watching how others live and taking lessons from it requires a supply of lives to watch. Both are cases where being among people is the instrument, and no amount of solitary effort substitutes." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note the one place he stops weighing", body: "This is the single case in the book that is decided rather than weighed, and the ground is worth marking. Teaching and learning are the greatest works in this world, and neither is conceivable without other people — so a man who still does not know what is required of him has made an obligation impossible by withdrawing. That is not a comparison of benefits. It is a case where one side of the scale has been removed from him by his own act." },
      { title: "Take the word he uses", body: "And the word is disobedient, not unwise or premature. The withdrawal is itself the wrong, which is a stronger claim than saying he would be better off learning first — and it explains the saying that follows: become learned, then withdraw. The order is not advice about how to get the most out of a life. It is the condition under which seclusion is available at all." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Follow the three cases", body: "The three cases are separated by two different things and it helps to keep them apart. The first turns on knowledge: he does not yet know what is required of him, and that closes the question. The second and third both concern a man who does know, and they are separated by capacity — whether going deep into the sciences is within him. If it is not, worship in solitude is right for him. If it is, withdrawing before learning is called the utmost loss." },
      { title: "See what that asks of the reader", body: "And that puts the whole ruling on an honest estimate of one's own ability, which is an uncomfortable place to leave it. A man inclined to solitude has every reason to conclude that the sciences are beyond him, and a man inclined to prominence has every reason to conclude the opposite. Ghazali does not supply a test. What he supplies is the knowledge that the answer turns on this, which at least means the self-assessment is being made deliberately rather than by drift." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what makes both lists usable", body: "The reason this chapter works as an instrument is that nothing on either list is a disposition. Six benefits of solitude and seven of company, and every one of them is something a person either obtains, suffers, or is unable to do. None of them is being more devout, or more sociable, or better suited to one life than another. Which means a reader can go down both columns and mark them, and the marks are facts about his situation rather than judgements about his character." },
      { title: "See where the question ends up", body: "And the closing form of the question is the useful one. Not whether solitude is better — that question has no answer and two centuries of named authorities failed to settle it. But what this person would gain and what he would stop being able to do. Which is answerable, differs from person to person, and can be asked again when circumstances change. It is the same shape the marriage book arrived at, and the two together establish how the Quarter of Custom handles a genuinely open question." },
    ],
    closer: [
