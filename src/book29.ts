...
export const book29Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Explain why knowledge is fastest", body: "Learning readily produces a man who expects to be greeted first, treats a courtesy as a debt owed to him, and looks at ordinary people as though they were cattle, while in the matter of the hereafter he fears for them more than for himself and hopes for himself more than for them." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Isolate the third", body: "Conceit is the third state: not fearing, rejoicing, and resting secure, where the joy is in taking it as his own achievement rather than as something given. Whenever the heart is dominated by the awareness that it is a blessing God may strip whenever He wills, conceit departs." },
  ...
  makeChapter({
    ...
    moves: [
      { title: "Give the first four", body: "Conceit in the body, in strength, in intellect, and in noble lineage. Each treatment points out how fast whatever he is proud of can be taken away: a fever dissolves strength beyond recovery, a slight illness of the brain deranges the mind." },
