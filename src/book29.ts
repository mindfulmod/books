...
export const book29Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Take the reading given for every encounter", body: "And the instrument supplied to the scholar is the most practical thing in the book. For each person he meets there is a reading available: the ignorant sinned in ignorance and is more excusable; the learned knows what I do not; the older worshipped before me; the younger has not yet had time to sin as long as I have; and the man in error may end in guidance while I end in his position. Every case has an answer, which leaves no encounter in which the comparison runs his way." },
