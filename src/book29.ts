...
export const book29Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    audit: ["In my last disagreement, was I hunting truth or victory?", "What did I do when the other person was right?", "Which command becomes negotiable when it reaches me through someone I rate low?", "Where does refusing a person shade into refusing what he carries?"],
