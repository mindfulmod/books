...
export const book29Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Follow the three states", body: "And the three states are separated by one variable: what the man does with the awareness that it was given. Fearing its loss is not conceit. Rejoicing in it as a blessing from God is not conceit. Conceit is the third — not fearing, rejoicing, and resting secure, with the joy taken in it as his own achievement. So the same quality, the same pleasure, and the difference is entirely in whose the thing is taken to be." },
