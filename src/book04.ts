...
export const book04Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    moves: [
      { title: "Start from a command and a prohibition", body: "“Establish the prayer for My remembrance.” The plain sense of a command is that the thing is obligatory, and heedlessness is the opposite of remembrance — so somebody heedless right through his prayer, in what sense is he establishing it for God's remembrance? Then the other side of the same point: “and do not be among the heedless.” The plain sense of a prohibition is that the thing is forbidden. Ghazali is not quoting these for encouragement. He is running the standard jurist's inference — apparent sense of a command, apparent sense of a prohibition — and letting it land where it lands." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Say what they complete", body: "Notice that every one of the six is defined by what it adds to the one before it, which is why they cannot be summoned as a single feeling. That is also why the chapter treats each with its own causes and its own remedy: on this account the physical act can be flawless, and the first two fully present, and the prayer still be missing four of the six things that would make it alive." },
    ],
    closer: [
