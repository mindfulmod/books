...
export const book04Chapters: Chapter[] = [
  makeChapter({
    ...
    distinction: ["Two kinds of chapter in this book", "Procedural", "How the act is performed, who leads it, when it falls, and which prayers are voluntary.", "Argumentative", "The third chapter, which argues about what the act requires inwardly and has legal consequences."],
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note the small piece of reasoning he leaves in", body: "Even here, Ghazali lets his own judgment show. He reports three transmitted timings for the opening phrase: while the hands rise, while they remain raised, or while they come down. None is wrong, but he considers the last the best fit. The phrase binds the worshipper into prayer, laying one hand over the other makes that binding visible, and the binding begins as the hands drop. The sound and gesture should therefore start and finish together. The point is small, but it shows his method: when the reports leave room, he asks what the act means and lets that meaning guide the form." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      { title: "Separate reverence", body: "Reverence is something further, beyond presence and understanding, and Ghazali demonstrates it with an example anyone can recognize. A man speaks to somebody who works for him. His heart is fully present, and he understands every word he is saying, but there is no reverence in it at all. Complete attention and comprehension therefore do not add up to reverence. Something else must be present; concentration alone does not produce it." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Give the exercise", body: "Ghazali proposes a revealing exercise: imagine during prayer that an upright member of your household is watching, or someone whose good opinion you value. The body quickly becomes still and the limbs settle because one fears appearing irreverent before another human being. The contrast exposes how much more awareness should follow from knowing that God sees the prayer." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "State the danger, and the way out", body: "Ghazali does not soften the conclusion. If desire is what actually governs a person, then saying that God is greater risks becoming speech the heart does not support. He treats that exposure seriously and names three responses: turn back, ask forgiveness, and maintain a good opinion of God's generosity and pardon. He does not lower the standard to remove the problem. He places mercy beside the full demand rather than using mercy to erase it." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what that produces", body: "The chapter is organized around the reader's practical situation. That is why it sits between the Friday prayer and the voluntary prayers instead of being distributed through the earlier material." },
  ...
  makeChapter({
    id: 19, shortTitle: "Beyond the obligatory", formalTitle: "The voluntary prayers",
...
export const book04ConceptNodes: ConceptNode[] = [
  ...
  ["nawafil", "Voluntary prayers", "Four cycles", "Day, week, year, and occasion — the shape of a life rather than a list."],
...
export const book04Movements: TaxonomyGroup[] = [
  ...
  ["bab7", "7. Voluntary prayers", "Four cycles: day, week, year, and occasion.", [19]],
