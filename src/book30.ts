...
export const book30Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Take the harder case seriously", body: "And the party in the right is deluded from a different direction entirely, which is what makes this section worth having. They were correct, and they supposed that arguing was the most important thing a person could do and the highest act of drawing near — and then added the corollary that nobody's religion is complete without investigation, so that a man who assents to God and His Messenger without framing a proof is either not a believer or not fully one. Being right about the doctrine did not protect them from being wrong about what a life is for." },
    ],
    closer: [
