...
export const book21Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    moves: [
      { title: "Name the visible army", body: "Hand, foot, eye, ear, tongue, and the rest of the outward and inward organs are all servants of the heart, made compliant to it. It orders the eye open and it opens; it orders the foot to move and it moves." },
    ...
    closer: [
      { title: "The five inward chambers", body: "The perceiving class divides again. Some faculties are lodged in the outward stations, the five senses; others in inward stations in the brain's cavities, and these are five as well: the common sense, imagination, reflection, recollection, and retention. Close your eyes after seeing a thing and its form remains with you, and that is imagination." },
    ...
    distinction: ["Two kinds of army", "Seen with the eye", "Limbs and sense organs, which belong to the visible world.", "Seen with insight", "Appetite, anger, will, power, and the inward perceiving faculties, which do not."],
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Show how the realm is governed well", body: "When the ruler consults his vizier, turns away from that servant's counsel, and sets his police chief over him so that the servant is governed and not governing, the realm is sound and justice follows. The self does this by setting the intellect over both and using each against the other." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Correct the obvious picture", body: "The mirror image is preferable to the image of a hand grasping a sword, because the thing itself does not come to be in the heart. One who knows fire does not have fire in his heart; what he has is a likeness matching its reality." },
  ...
  makeChapter({
    ...
    closer: [
      { title: "The blind man in the house", body: "To one who supposes the rational and revealed sciences contradict each other and cannot be joined, Ghazali answers with a man who enters a house, stumbles over the vessels, and asks why they were left in the way. He is told they are in their places, and that the wonder is that he attributes his stumble to another's negligence rather than to his own blindness." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "State the actual difference", body: "Inspiration does not differ from acquisition in the knowledge itself, nor in its seat, nor in its cause. It differs only in the removal of the veil, and that removal is not by the servant's choice." },
    ],
    closer: [
    ...
    distinction: ["Two arrivals of the same knowledge", "By acquisition", "The obstruction is worked at from the person's side by study and inference.", "By inspiration", "The obstruction is lifted from the other side, which is not the servant's to arrange."],
