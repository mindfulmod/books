...
export const book21Chapters: Chapter[] = [
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what the whole section is doing", body: "These definitions make the later disputes intelligible: two readers may use the same word while referring to different senses. The shared knowing self is one meaning alongside the four distinct physical or technical meanings." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Follow the derivation", body: "The order matters: each inward power is explained through what the journey requires. The faculties are not first assumed and then given a purpose." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what the three analogies each supply", body: "The realm concerns government, the frontier concerns entrusted responsibility, and the hunt concerns training. Each image adds a different question about the same inward forces." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note how the difference is proved", body: "The examples test the distinction through conflict: immediate appetite and concern for an outcome can pull in opposite directions. The medical practices named are Ghazali’s historical examples, not recommendations here." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Take the account of the devil's method", body: "Deception works through powers already present. What appetite and anger want can be made to appear good, so recognizing the appearance of a reason is not yet testing it." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what the double refusal costs each side", body: "Joining the two roots preserves a role for reason and for revelation. The instruction does not resolve their relation by setting either one aside." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note where the three ways differ", body: "The classification attends to how knowledge arrives and what its recipient knows of that arrival. It does not make every unbidden impression a trustworthy inspiration." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Follow the reservoir carefully", body: "The reservoir separates two kinds of effort: bringing something in and clearing what obstructs an opening. The surrounding argument also warns against abandoning study in expectation of an inward gift." },
      { title: "Note what the two doors establish", body: "The image describes attention turning in different directions. It should be read together with the preceding caution about neglecting learning; the comparison is not a general prohibition on acquired knowledge." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note the careful statement of the claim", body: "The collected testimony supports the possibility of knowing beyond deliberate instruction. It does not authenticate a particular reader’s impression." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Take the chain from prompting to act", body: "Separating the links lets the reader ask where a response became settled. Section 13 returns to this question with a more exact distinction between involuntary arrival and chosen intention." },
  ...
  makeChapter({
    ...
    closer: [
      ...
      { title: "Why the order had to come first", body: "Judgment is not uniformly voluntary: Ghazali says circumstances differ, and only its voluntary form is held against the person. The question is usually asked as though there were one thing called a bad thought. Ghazali's answer is that there are four things, that they arrive in sequence, and that the answer differs at each, which is why he refused to answer before laying out the sequence." },
    ],
    distinction: ["Two things inside one bad thought", "What arrives", "The prompting and the stirring of appetite, which are outside choice and are pardoned.", "What is settled", "Judgment must be distinguished as voluntary or involuntary; settled resolve is treated separately from passing inner speech."],
  ...
  makeChapter({
    ...
    moves: [
      { title: "The first account: cessation", body: "One group holds that suggestion ceases with remembrance, understanding the withdrawal named in the report as silence." },
      ...
      { title: "What the five positions explain", body: "The five positions address one problem: what happens to the suggestion in somebody wholly occupied with remembrance. Does it cease, persist without effect, like a voice heard by a preoccupied man who does not take in the words? Does it lose only its dominance, so it whispers weakly from a distance? Do the two alternate too fast to distinguish, like points on a spinning ball? Or do both run at once, as two eyes see two things?" },
      { title: "Take the verdict seriously", body: "And the verdict is that all five are correct, and that each falls short of covering the classes of suggestion. Which is the same move the book on knowledge made about the word intellect and the book on creed made about faith and submission: a long dispute where each party described one case accurately and generalised it. What is being corrected is not any of the five observations but the assumption that suggestion is one kind of thing." },
    ],
    closer: [
      { title: "What the move accomplishes", body: "The disagreement is dissolved by denying that its subject was single. Once suggestion is admitted to have classes, five incompatible descriptions become reports describing different kinds of suggestion." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Follow the mechanism in the first two hearts", body: "Both hearts consult the intellect. What differs is the habit of its service: examination under knowledge or ingenuity in carrying out caprice. Intelligence alone does not settle the direction." },
