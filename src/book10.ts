...
export const book10Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Give the shape", body: "The practice has three scales: an hour after sunset each day, portions of every night, and particular nights of the year. Book 4 uses the same descending cycle for voluntary prayers." },
    ...
    closer: [
      ...
      { title: "The completion of the quarter", body: "Book 4 sorted voluntary prayers by day, week, year, and occasion. This chapter organizes night worship in the same way. The Quarter of Worship therefore ends by giving the reader a pattern for devotional time at every scale." },
    ],
