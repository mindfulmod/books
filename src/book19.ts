...
export const book19Chapters: Chapter[] = [
  makeChapter({
    ...
    moves: [
      ...
      { title: "Give the consequence of neglect", body: "If this duty were put away and both its knowledge and practice abandoned, the public work of prophecy would stand idle and religion would erode. Listlessness, error, ignorance, and corruption would spread without correction. The tear in communal life would widen, lands would fall into ruin, and people could perish without recognizing what had happened until the Day of Calling." },
      { title: "Give the turn to the present", body: "Ghazali says that what was feared has occurred: the knowledge and practice of this central duty have worn away until almost no trace of its reality remains." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Give the four examples", body: "A person should not secretly listen at another's house for the sound of instruments, or sniff for the smell of wine. He should not feel what is concealed in someone's clothing to discover the shape of a pipe. Nor should he question the neighbors to learn what happens inside the house." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Give the first half", body: "When an act is legally disliked, stopping it is recommended, and remaining silent about it is itself disliked but not forbidden. The case changes if the person does not know the ruling. Teaching the ruling then becomes obligatory because legal guidance must reach people who do not know it." },
