...
export const book11Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "See why departure gets its own manners", body: "And giving the departure a place of its own says the occasion is not over when the eating stops. There is a way of leaving — when, how, what is said — and it is owed rather than optional. A guest who eats attentively and then goes badly has failed at a sixth of the thing, which is a considerably more demanding account of being a guest than most people carry." },
