...
export const book08Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Eighth: seeking refuge", body: "Begin by seeking refuge in God, the Hearing, the Knowing, from the accursed Satan. Ghazali cites the verse that asks God for protection from the devils' promptings and presence." },
