...
export const book08Chapters: Chapter[] = [
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note that he built the objection in", body: "That is worth registering as a piece of construction. He does not answer the charge in a footnote or wait to be attacked and reply later; he gives the objection a quarter of the book, states it in the strongest form he can find, and names the people making it. A writer confident of his position and careless of his readers would not bother. A writer who knows his third chapter licenses something genuinely dangerous — telling ordinary readers to find meanings in the text for themselves — has to, because the danger is real and he is the one introducing it." },
      { title: "See the shape the book shares", body: "And the four-part shape is the standard shape of the Quarter of Worship: praise, then the outward act, then the inward act, then whatever difficulty the inward act has created. Prayer runs the same way, and so does the pilgrimage. What is unusual here is only the fourth part. In the other books, the difficulty is practical — how to hold your attention, what to do about distraction. Here it is a charge of unbelief, which is why this book ends in an argument with named opponents rather than in a set of instructions." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Say why the reproach has to be here", body: "Putting the blame in the same chapter as the praise is not a stylistic choice. Praise for reciting the Quran, taken alone, produces exactly one behaviour in a motivated reader: more of it, faster. Every one of the merits is easier to collect by increasing volume, and none of them says anything about what should be happening while the volume is collected. The warning has to arrive in the same breath, or the encouragement does damage before the correction can reach it." },
      { title: "Name who falls short", body: "And notice who the reproach is actually about. Not people who neglect the Quran — a person who never opens it is not falling short in reciting it. The blame lands on the people doing it, in quantity, and doing it in a way that leaves them untouched. That is the same target as the fussiness chapter in the book on purification and the distracted worshipper in the book on prayer: in each case the person being corrected is the one already putting in the hours, and in each case the correction is unwelcome for exactly that reason." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note that the manners start with the person", body: "It matters that the list opens on the reciter's own condition rather than on the book, the place, or the words. Purity, stillness, composure: none of these is about the Quran at all, and all of them are about who is showing up to it. The implication is that the encounter is already underway before a single word is read, and that a person who arrives distracted and half-arranged has settled how the next hour will go before he has begun it." },
      { title: "See what the outward manners are actually doing", body: "And these instructions work the way the outward acts of prayer work: they are ways of moving what is inward, by putting the body into a shape the heart can follow. You cannot decide to revere something. You can sit as somebody sits who reveres it, and the sitting has an effect the deciding does not. That is why a chapter with no arguments in it is not merely preliminary to the chapter on inward acts. It is the part of that chapter a person can actually perform on demand." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Second: how much", body: "Reciters vary wildly — some finish the whole Quran in a day and a night, some twice, some three times, others once a month. Ghazali says what settles it is the report: “whoever reads the Quran in less than three days has not understood it.” Anything faster makes measured reading impossible." },
      ...
      { title: "Take the measure he gives for sitting", body: "The standard for how to sit is the most useful sentence in the chapter, because it converts an unmeasurable requirement into one anybody can check. Sit alone with the Quran as you would sit in front of your teacher. You know exactly what that looks like — you do not sprawl, you do not let your eyes wander round the room, you do not carry on with something else at the same time, and you do it without anyone having to specify any of it. He is not adding a rule. He is pointing at a posture you already know how to produce and telling you where else it belongs." },
      { title: "See what A'isha's remark is measuring", body: "And her line is sharper than it first sounds. She does not say the man recited badly. She says he did not recite, and he did not stay silent either — the two things a person might have usefully done, and he managed neither. Speed did not produce a worse version of reading; it produced something that is not reading, while consuming the time and the appearance of it. That is why the three-day floor is not a recommendation about pace. It is a claim about what stops being possible below it." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Take the instruction about manufactured weeping seriously", body: "The line about weeping deserves more attention than it usually gets, because it appears to license a fake. If you do not weep, make yourself weep. Ghazali is not recommending theatre — there is no audience in a chapter about reciting alone. He is applying the same principle as the sitting: a state you cannot summon directly can sometimes be reached through its own outward shape, and the attempt is not a lie about what you feel but an approach to what you do not yet feel. The alternative is waiting to be moved, which for most people means waiting indefinitely." },
      { title: "Note where the limit on beauty falls", body: "And the tenth item is carefully bounded in a way that tells you what the whole chapter is for. Make the voice beautiful — but not with the kind of drawn-out ornament that bends the words out of shape. The line is drawn exactly where the beauty starts competing with the sense. That is the test running under all ten manners: everything that helps the words arrive is encouraged, and everything that turns the recitation into a performance in its own right, however impressive, is cut off." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note where the list starts", body: "The order tells you what he thinks goes wrong first. He does not begin with attention, which is where anybody writing this today would begin. He begins with what the text is and whose speech it is — because attention is not a quantity you can raise by effort, but a consequence of what you take yourself to be holding. Somebody who has genuinely registered where the words came from does not then need to be told to concentrate. Somebody who has not registered it will not manage to concentrate however hard he is told." },
      { title: "See why the last three are not instructions", body: "And the final three are of a different kind from everything before them. Being affected, ascending, disavowing — none of these can be performed on request. You cannot decide to be moved by a verse any more than you can decide to find a joke funny. What the first seven can be made to do is remove every obstacle in the way, and then the last three are what happens, or does not. The list is honest about this: it stops issuing instructions at exactly the point where instructions stop working." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Follow the argument", body: "Track what that argument actually establishes, because it inverts the ordinary complaint. A reader might be disappointed that the Quran comes in plain Arabic sentences he can parse — that the thing is not more overwhelming than it is. Ghazali's answer is that the ordinariness is the concession, not the shortfall. A human being can only take in what arrives in human terms, so the letters are not a thin covering over the real thing; they are the only form in which the real thing could reach anybody at all without destroying them." },
      { title: "Note what this does to the reader's position", body: "Which changes what a person is doing when he opens it. He is not examining a text that is available to him as texts generally are. He is receiving something that has been deliberately brought down to a level he can survive, by a decision that was a kindness rather than an obligation. That is the recognition the first inward act consists of, and it is why it comes before all the others: every other item on the list follows naturally from holding it, and none of them can be produced without it." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Say why magnification cannot be commanded", body: "The second act looks like an instruction and is not one. Bring the greatness of the speaker into your heart — try it on demand and you will find there is no lever. What Ghazali has done is put it immediately after the first act, because the first is something you can genuinely think through: the argument about the letters can be followed, checked, and held. Magnification is what follows from having followed it. So the instruction is not really do this; it is understand that, and this will be there." },
      { title: "Note what the borrowing from Book 4 implies", body: "And the third act is simply imported, definition and all, from the book on prayer. That is a substantive claim, not a saving of space: wandering during recitation and wandering during prayer are one problem, with one cause and one treatment. Which means everything established there applies here — that the states are already in you, that thoughts are what displace them, and that the real work happens outside the act rather than inside it. A reader who wants his recitation fixed is being sent back to the earlier book." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Separate the fourth from the fifth", body: "The distinction between the two is easy to miss and worth holding. Pondering is turning a verse over: staying with it, letting it sit, noticing what it connects to. Seeking understanding is going after what is meant — asking a question and pursuing an answer. The first is receptive and the second is deliberate, and a reader can be good at one and not the other. Somebody who only ponders drifts pleasantly and concludes nothing; somebody who only investigates gets his answer and never lets the verse do anything to him." },
      { title: "Say what kind of impediment is meant", body: "And the impediments are not ignorance of Arabic or a shortage of commentaries — those would be listed under equipment, and they would come earlier. What blocks understanding here is what the reader brings: a settled position he is unwilling to have disturbed, a sin he has no intention of leaving, an attachment that makes certain verses unwelcome. These are only discoverable by running into them, which is exactly why the item sits where it sits. You learn what you are refusing to understand by finding the place where the understanding will not come." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Say what the default stance protects", body: "It is worth being honest about what specification costs, because the default it displaces is extremely comfortable. Read the Quran as describing categories of people and every hard verse has somewhere to land that is not you: the hypocrites are other people, the heedless are other people, the ones who took the world are other people. Nothing in the text forces the reassignment — the descriptions really are general. Specification is a decision made by the reader in advance, and it is the decision that makes the rest of the book's claims about being changed by reading even possible." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "See what the ninth actually describes", body: "The ninth is the strangest item and the one worth slowing down on. Ordinarily you read and hear your own voice saying the words — they are yours, produced by you, at your pace. Ascending is when that stops: the words arrive rather than being produced, and the reader is on the receiving end of his own recitation. Ghazali calls this the highest thing a reader reaches, and he describes it rather than prescribing it, because there is no procedure that puts anybody there." },
      { title: "Note why the list has to end this way", body: "And then the tenth takes it back. If the sequence stopped at the ninth, a reader who reached it would now possess something — an achievement, a level, a thing to have reached — and possessing it is precisely what would spoil it. So the last item is not a further stage but a disclaimer applied to everything preceding: no power and no strength of his own, and no looking at himself with satisfaction. The list is built so that its own summit cannot be occupied." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Say why the dilemma is real", body: "And the dilemma bites in both directions, which is why it needs a chapter. If the exegetes are right that meaning is fixed by transmission, then everything the third chapter recommended — pondering, seeking understanding, having the verse open onto you — reduces to recalling what somebody else already established, and the inward acts collapse into memory work. If they are wrong, then the report threatening interpreters is either false or empty, and neither is available to him. He cannot get out by giving ground on either side." },
      { title: "Note that the charge was not hypothetical", body: "It is also worth registering that this was a live accusation with a body count, not an academic puzzle. Ghazali names it plainly: the plain-commentary scholars were calling this unbelief, aimed at figures associated with Sufism who read the Quran against what came down from Ibn Abbas and the rest. He is writing as somebody who has just recommended a practice that people are being condemned for, and the chapter is his account of where the line falls — which is a considerably more exposed position than a defence of his own reputation." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "See how the first move works", body: "The opening move is the sharpest thing in the chapter, and it wins by reframing rather than by refuting. Somebody says the Quran means nothing beyond the plain commentary. Ghazali does not call that false — he accepts it as an accurate report, and then points out what it is a report about. The man is describing where his own understanding stops, which he is in a good position to know. His error is only in the next step, turning a fact about himself into a ceiling for everybody. Read that way, the strict position is not wrong so much as overextended." },
      { title: "Note what the seventy camels prove", body: "And the evidence is chosen so that each piece does a different job. Ali's line about being given understanding in the Quran shows that something exists beyond the transmitted rendering, or the phrase means nothing. The saying about an outward and an inward, a limit and a place of ascent, states the structure directly. And the seventy camels of commentary on the Opening make the point by sheer arithmetic: the outward sense of that sura can be given in a paragraph, so whatever would fill seventy camel-loads is not the outward sense." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Name what the two aspects have in common", body: "Both faults are versions of one thing: arriving with the answer. In the first the answer is a position the reader already holds, and the verse is recruited to support it. In the second the answer is whatever the Arabic looked like it said on a first pass, adopted before checking what the words meant to the people they were addressed to. Neither is a failure of reverence and neither requires bad faith. Both are the reader supplying the meaning and then finding it in the text, which is what interpreting by opinion turns out to name." },
      { title: "See how narrow the prohibition turns out to be", body: "Which resolves the dilemma without weakening either side. The report stands at full strength, and it forbids something specific and genuinely common — using the text to underwrite what you already wanted. What it does not forbid is a reader coming to the Quran without a position to defend, equipped with what has been transmitted, and finding that it opens onto him. The third chapter recommended the second. The report prohibited the first. They were never in conflict; they were being read as though the word interpretation named one activity when it names two." },
      { title: "Note the honesty of the third variety", body: "And the hardest case is the one he puts third, where the aim is good. A man wants people seeking forgiveness before dawn — an unimpeachable thing to want — and reaches for a report about the pre-dawn meal, calling it a meal of remembrance while knowing perfectly well it means breakfast. Nothing bad is being promoted and nobody is misled about anything that matters. It is still the prohibited thing, and Ghazali includes it precisely because it is the version a sincere person will commit. The rule is about the operation, not about the outcome it is used to serve." },
    ],
    closer: [
