...
export const book14Chapters: Chapter[] = [
  makeChapter({
    ...
    moves: [
      { title: "Announce the seven", body: "The seven chapters begin with the excellence of seeking what is lawful and the blame of what is unlawful, including the degrees of each. They then cover the ranks and sources of doubtful matters; when to investigate, ask, become deeply involved, or leave a matter alone; and how a repentant person clears financial wrongs. The final chapters address rulers' stipends and gifts, entering into rulers' company, and a set of related questions." },
      ...
      { title: "Note what the third chapter's subject really is", body: "It is worth catching the inversion at the centre of the book. A doctrine of scruple should, by every expectation, be about how to check things — what to look into, how far to press, when to be satisfied. Ghazali's third chapter is largely about when not to check, because he treats asking as a harm in its own right. Which means the scruple is not maximised by investigating more; there are two costs on the scales, and diligence about one of them incurs the other." },
      { title: "See why the last four chapters are the hard part", body: "And the final four are where an abstract doctrine meets a society. Restitution when the person you wronged cannot be found. Government stipends, when the source of public money is mixed. Being near power at all. These are not marginal cases — they are what happens to anybody with a doctrine of scruple who has to live in a state, and Ghazali does not resolve them by keeping the doctrine pure and recommending withdrawal." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Follow the two axes of the grading", body: "The severity is being tracked along two independent axes, and the examples are chosen to separate them. A defective contract abandons the Law's route in acquiring but harms nobody; seizure by force does both, which is why it is graver. Then the second axis: the same theft from a poor man, a righteous man, or an orphan is fouler than from somebody rich, strong or corrupt. So the wrong varies both with what was done and with who it landed on." },
      { title: "Note the argument from the Fire", body: "And the proof offered is neat and worth catching. If wrongs did not differ in degree, the punishments would not differ in degree either — and they are reported as differing. So the grading is not a softening introduced by moralists to make prohibition livable; it is presupposed by the way the consequences are described. Which means the person who insists the unlawful is simply the unlawful, admitting no more and no less, has a text problem rather than a rigour advantage." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Take the refusal seriously", body: "The refusal is a piece of intellectual honesty that costs him something. A list of four degrees of the unlawful would be quotable, teachable and memorable, and it is exactly what a reader arriving at this chapter expects. He declines on the ground that any number would be invented — it would run as arbitrariness, and it is looking for a count of something nothing counts. So the reader is handed variables instead of a list, and has to do the grading himself." },
      { title: "See what this reveals about the rest of the Ihya", body: "And this is the passage that shows the numbered lists elsewhere are claims rather than a habit of presentation. Six inward meanings of prayer, eight duties of alms, ten manners of recitation, four levels of purity — if Ghazali numbered things because numbering is how such books are written, he would have numbered here too. That he stops to say a number would be false means the numbers he does give are assertions that the divisions are real." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what calling it a text does", body: "Calling the report a text that establishes three categories is a technical move with a large consequence. A gap between two rules is a defect in the rules — something to be closed by better analysis, and nothing you could write a chapter about. A third category, named in a sound report, has a status of its own and can have its own rules, its own degrees, and its own procedure. The whole book depends on that distinction holding." },
      { title: "Take the shepherd image seriously", body: "And the image the report uses is doing precise work. The shepherd grazing at the edge of a protected area is not trespassing, and at no point does he decide to. The point is that animals drift, and a man who habitually works the boundary will end up over it without a moment he could identify as the crossing. Which is why guarding against the doubtful is described as protecting one's honour and one's religion rather than as a further piety: it is about where the failure comes from, not about being stricter than required." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "See why the second axis is the hard one", body: "The two axes are not equally difficult and it is worth being clear why. What a thing is, you can inspect — you can look at the food, taste it, know what it is made of. What has happened to it reaches back through every owner and every transaction it has passed through, and any one of those could have introduced a defect that survives into the object in front of you. So a loaf can be entirely wholesome in substance and fail the definition on something three owners back that nobody now alive could establish." },
      { title: "Note what choosing rain accomplishes", body: "And the rainwater example is not offered as advice, which is the standard misreading. Caught in the air, before landing, on his own or unowned ground — every clause shuts off another route by which a claim could have entered, and what is left is the one thing in the world with no history at all. Ghazali is defining the endpoint of a scale so a reader can see how far ordinary food sits from it, and stop treating the absolutely lawful as a standard that daily eating was ever going to meet." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note where the line between required and voluntary falls", body: "The first degree has a hard legal consequence and everything above it does not, which is the most useful distinction in the chapter. Failing the first degree means a man's testimony is not accepted — his word does not stand in court, and he carries the mark of corruption. That is enforceable and public. Every further degree is something a person takes on himself, and no consequence attaches to declining it. Confusing the two turns voluntary scruple into a standard other people can be failed by." },
      { title: "Take the adornment example seriously", body: "And the example he picks for the higher degrees is instructive: avoiding adornment, which he says plainly is permitted, because it may call to something else. That is the structure of every degree above the first — leaving what is not forbidden because of where it may lead. Which is why the report he attaches speaks of leaving what is harmless out of fear of what is harmful. The ascent is not into stricter rules. It is into acting on consequences that have not happened." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note where he draws the line and how", body: "What makes this section unusual is that the boundary is drawn by evidence rather than by temperament. Unease about the foetus found in a slaughtered animal is over the line — not because it is excessive in feeling, but because there is a sound report, with no weakness in text or chain, that the slaughter of the mother counts as the slaughter of the foetus. Unease about lizard is over the line because it was eaten at the Messenger's own table. In each case the scruple is refused by a fact, not by a judgement about how much scruple is seemly." },
      { title: "Follow the third rank, which is the subtlest", body: "And the third rank is the sharpest case, because the man reasoning his way into it sounds careful rather than obsessive. Nobody disputes the question; the permission rests on a single-chain report; transmitters can err and upright men can be mistaken; so he holds back. Every step of that is true. The test Ghazali applies is historical: nothing like it is transmitted from the Companions, whose souls were at rest with what they heard from an upright person. A scruple that would have made the first generation's ordinary practice impossible is not a higher standard than theirs." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note that both easy answers are refused", body: "The two refusals at the start of the chapter close off the two positions almost everybody actually holds. You may not investigate everything put in front of you, declining until each item is verified. And you may not abandon investigation and take whatever is not certainly forbidden. The first is the scrupulous person's default and the second is everyone else's, and both are ruled out in consecutive sentences — which is what forces the chapter into a four-way ruling rather than a rule." },
      { title: "See what the criterion actually gives you", body: "And what replaces a rule is a trigger: asking belongs to the places of misgiving, and misgiving comes either from something about the property or from something about its owner. That is genuinely usable, because it locates the duty in a specific occasion rather than in a general disposition. A man is not required to be suspicious. He is required to act when something has actually given him pause, and to leave it alone when nothing has." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Follow the historical argument", body: "The argument from the first generation is the load-bearing one and it is worth stating in full. The Companions stayed in villages on campaign and did not refuse what was offered; they entered towns and did not guard themselves against the markets. And — this is the part that closes it — the unlawful existed in their time as well. So their not asking cannot be explained by their living in a purer society. They were in the same position and did not investigate, and no asking is reported from them except where something had actually given rise to misgiving." },
      { title: "See why the counter-examples strengthen it", body: "And the three cases where asking did occur are the proof rather than the exception. The Messenger asked whether what arrived was charity or a gift, because the circumstance itself raised the question. Abu Bakr asked his servant when something about the earning troubled him. Umar asked about milk whose taste was not what he expected. In every case something specific prompted it. They are a catalogue of what a place of misgiving looks like, which is exactly what the criterion needed." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Take the escalation seriously", body: "Notice how far he goes here. It is not merely that a man need not ask; he says outright that it is not for him to ask. And the alternative offered is not a stricter procedure but a gentler one: if you are being careful, decline quietly, and if you must eat, eat without asking. The scruple is preserved and relocated entirely into what the man does with himself, with nothing of it falling on the person who fed him." },
      { title: "Note the three words he uses for asking", body: "And the reason is given in three words, each naming a different injury: asking is a harm, a tearing of a covering, and an estranging. It hurts, it exposes something the man had kept covered, and it puts distance between two people who were until then on ordinary terms. Then the verdict — forbidden without doubt. Which is a stronger classification than anything he has applied to the doubtful food itself, and it is what turns the chapter from a procedure into a weighing." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Follow the symmetry", body: "The exchange is four lines long and it dismantles the position completely. Perhaps he will not be hurt by the asking — perhaps he will. So the man is investigating on the strength of a perhaps. And if a perhaps is enough to act on, then the perhaps on the other side is equally available: perhaps the wealth is lawful. The scrupulous position turns out to be applying the doubt in one direction only, and it has no principle that would justify doing so." },
      { title: "Note the weight assigned to each side", body: "And the weighing at the close is explicit about the relative sizes, which most treatments of scruple never are. The wrong of hurting a Muslim is not less than the wrong of eating something doubtful. Once that is granted the calculation is straightforward and it usually comes out against asking. And the last clause names the cumulative cost: investigating people is how you lose them — a doctrine of scruple pursued this way ends with a man alone, which was never what it was for." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "See what the last four chapters have in common", body: "The four are unified by a single problem: what a doctrine of scruple does when the money in circulation is mixed and cannot be unmixed. Restitution asks it backwards — what a repentant man owes and to whom, and what happens when the person wronged cannot be found. The stipends ask it forward, about money whose source is public and therefore partly unaccountable. Both are cases where the pure answer is unavailable and something has to be said anyway." },
      { title: "Note why the sixth chapter is not about money", body: "And the sixth chapter is the one that shows what the book is finally about. Entering upon rulers and mixing with them concerns no transaction at all — no payment is made, nothing changes hands, and there is nothing to be doubtful about in the terms of the first chapter. What is at issue is proximity, and what proximity does to a person's judgement over time. Which is the same subject as the fifth chapter of the book on earning: the last question is always what the arrangement is making of the man inside it." },
    ],
    closer: [
