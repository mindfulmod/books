...
export const book35Chapters: Chapter[] = [
  makeChapter({
    ...
    moves: [
      { title: "Gather the testimony", body: "The verses and reports commending reliance upon God are assembled, and they are extensive enough to make the state's rank clear before anything is defined." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "The fourth degree", body: "To see in existence only one, which is the witnessing of the truthful, and which the Sufis call annihilation in unity, since one who sees only one does not see himself either." },
    ],
    closer: [
    ...
    distinction: ["Two things called unity", "A knot", "The heart assents to the meaning and holds it, which is real and is what most people have.", "An unveiling", "The multiplicity is seen as issuing from One, which is a different rank and not a firmer version of the same one."],
  ...
  makeChapter({
    ...
    moves: [
      { title: "Derive the word", body: "Trust is derived from agency. To entrust a matter to someone is to commit it to him and rely on him in it, and the one entrusted is called an agent while the one who commits is called reliant, whenever his soul is at rest with him and does not suspect him of falling short." },
  ...
  makeChapter({
    ...
    closer: [
      { title: "Abu Yazid on the snakes", body: "Told that trust means the lions and vipers to your right and left would not stir your inmost self, Abu Yazid said this was close, and then went further. Ghazali reads the first as reporting the third station and the second as reporting the deepest knowledge, and adds that Abu Yazid rarely speaks except of the furthest degrees." },
      { title: "The correction that follows", body: "Not guarding against snakes is not a condition of the first station of trust. Abu Bakr blocked the snake holes in the cave, and Ghazali reasons that trust is lost by the stirring of the inmost self rather than by the movement of a hand, and that one who guards is not relying on his own contrivance but on the Creator of contrivance." },
    ],
  ...
  makeChapter({
    ...
    moves: [
      { title: "Reject the inference", body: "Trust does not entail the abandonment of work. The stirring of a hand is not what removes reliance; the stirring of the inmost self toward another reliance is." },
      { title: "Locate reliance correctly", body: "One who takes a means is not relying on his own contrivance and strength if his heart rests on the Creator of contrivance and strength. The means and the reliance are on different levels." },
      ...
      { title: "Keep the state central", body: "In every case the test is where the heart rests, since the outward act is compatible with both conditions and therefore cannot settle the question by itself." },
    ],
    closer: [
      { title: "Why this had to be argued", body: "The reports on trust are strong enough that a reader can reasonably infer that means are a defect. Ghazali answers by relocating the state, so that the outward act ceases to be the evidence either way." },
    ...
    distinction: ["Two people taking the same means", "Relying on the Creator", "The hand moves and the heart rests on the One who made both the hand and its effect.", "Relying on the means", "The heart rests on the arrangement itself, which is what removes trust."],
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Watch the disturbance", body: "What is examined is the stirring of the inmost self, which is the criterion the whole second half has been using." },
    ],
    closer: [
