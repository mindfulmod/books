...
export const book38Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Give the image", body: "The shepherd keeps the flock in order, and the heart plays that role for the limbs. When the heart becomes absorbed in the One worshipped, the limbs move rightly without constant management. The person's many concerns have become one concern, and God has made the remaining concerns sufficient." },
    ...
    distinction: ["Two ways the limbs are kept straight", "By management", "Each act watched, weighed, and steadied, which is the second degree.", "By a single concern", "The heart is absorbed, so the limbs run straight without constant management."],
    ...
    model: pair("Two routes to straight limbs", "The first degree does without the management entirely.", [["The shepherd absorbed", "A single concern, and the limbs run straight without constant management.", "support"], ["Each act managed", "Weighed and steadied one by one, which is the second degree's work.", "balance"]]),
  }),
  makeChapter({
    ...
    moves: [
      ...
      { title: "State it as an obligation", body: "Ghazali says that every servant must watch the soul when intending an act and when beginning to move. Pause before committing to the intention and effort. Let knowledge disclose whether the act is for God, in which case it should be carried out, or whether it serves the soul's whim, in which case one should guard against it." },
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "The first register", body: "Why did you do this? Was it required of you for your Master, or did appetite and personal desire draw you toward it? If the act passes this first question, the person is asked about the second register." },
  ...
  items: [
    {
      ...
      axes: [
        {
          ...
          options: [
            { id: "owed", label: "It was owed — I had to do it", note: "Required of you for your Master, which is what passing this gate means." },
      ...
      verdicts: [
        { key: "appetite|*|*", name: "It stops at the first register", role: "warning", chapterId: 8, body: "Ghazali's first question is whether the act was required of you for your Master or whether appetite and personal desire drew you toward it. Your answer places this act in the second category, so the second and third registers are never opened for it.", action: "This is useful rather than damning. If you came to this book worried about sincerity, the sequence shows that your work is not yet there. It is at the first gate, where Chapter 6's pause before intention is practiced." },
