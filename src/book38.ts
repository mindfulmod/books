...
export const book38Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Mark what follows", body: "Ghazali then reports the practice of those who travelled this road, and the accounts he transmits are severe: a man who put his hand in the fire after touching a woman, and one who left his foot exposed to rain and snow after he had begun to move it toward a wrong." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    closer: [
      { title: "Why this station is not in the analogy", body: "A merchant stipulates, watches, reckons, and charges a loss, and there the commercial model ends. Reproach is addressed to a party you cannot dissolve the partnership with and whose character can actually change, and Ghazali needs it because the aim of the whole book is the purifying of the soul rather than the containment of it." },
