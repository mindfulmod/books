...
export const book12Chapters: Chapter[] = [
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note the range the three positions cover", body: "The three positions are not variations on a theme; they cover the whole field. One says marriage beats devoting yourself to worship outright. One says worship wins, but attaches a condition — unless the longing for marriage is strong enough to disturb the state, in which case the calculation changes. And one says that in this particular age the better course is to leave it, because earning has become constrained and character has declined. Between them there is no position left over, and Ghazali endorses none of the three at the outset." },
      { title: "See what the third position concedes", body: "And the third is the interesting one, because it does not claim marriage is worse in itself. It says the merit it once had depended on conditions that no longer hold — money was easier to come by lawfully, and people were better. Which makes the verdict contingent on a state of affairs rather than on the institution, and it sets up the whole method of the chapter: the answer will turn on circumstances, and circumstances differ." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what the method rules out in advance", body: "Announcing that both sets of reports will be gathered and both benefits and harms enumerated is a commitment made before any conclusion. It means the chapter cannot end in a general recommendation, because a weighing has to be performed by somebody with particular exposures, and no author can perform it on a reader's behalf. Ghazali is designing the chapter so that it produces different answers for different people, and saying so at the start." },
      { title: "See how unusual the announced purpose is", body: "And the stated purpose is precise: so that the merit of marrying, and of leaving it, becomes clear in the case of anyone who is safe from its harms and anyone who is not. That is not a book arguing for a position and honestly noting objections. It is a book supplying an instrument, with the explicit expectation that the instrument will point one way for some readers and the other way for others." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Say why the child is called the root", body: "Calling the child the root and saying marriage was instituted for it is a claim about purpose rather than about value — it settles what the institution is for, not what any particular person should do. And the aim given is deliberately impersonal: preserving the line, and the human kind not running out. Which means the first benefit is stated at the scale of the species, and the harms it will shortly be weighed against are all stated at the scale of one man's religion." },
      { title: "Note what that mismatch does to the argument", body: "That mismatch is exactly what the closing cases exploit. A benefit belonging to the world's continuance has to be set against a loss belonging to a particular person's standing before God, and the two are not measured in the same units. Ghazali will resolve it by an accounting move — treating the child as a supposed good and the damage to religion as an immediate one — but the difficulty is built into the list from its first item." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note how the second benefit is constructed", body: "The second is stated as five effects rather than one, and the spread is doing something. Fortification against the devil, breaking the urge, repelling the harms of appetite, lowering the gaze, guarding the private parts — several of those are the same thing described from different angles, and stacking them registers how much weight this single benefit is being asked to carry. It is the item that will decide the chapter's second worked case on its own." },
      { title: "Take the third benefit seriously", body: "And the third is the one a stricter writer would have left out: refreshing the soul, sitting together, looking, playing. Ghazali does not defend it as a permitted indulgence to be excused. He defends it functionally — as rest for the heart and as what strengthens it for worship — which makes ordinary domestic pleasure part of the machinery rather than a concession to weakness. The same reasoning appeared in the varying of the litanies, and it is the Ihya's standing position on enjoyment." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what the fourth benefit assumes", body: "The fourth is the one that has aged furthest, and it is worth stating plainly what it says. Being freed from cooking, sweeping, laying out, washing up and preparing what is needed is counted as a benefit — to one party, because the work is done by the other. That is a description of a particular household arrangement in a particular society, presented as an advantage of marriage. The item survives here as evidence of the world the book was written in, not as counsel." },
      { title: "See why the fifth is the odd one out", body: "And the fifth breaks the pattern entirely. The first four are things a person gets: a child, protection from appetite, comfort, relief from housework. The fifth is a burden — looking after people, meeting their claims, putting up with their characters, absorbing what they do to you, working for their good — counted as a benefit purely because of what carrying it makes of you. It is the only item on the list that is good by being hard, and it is the one the harms will mirror exactly." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note why this harm ranks first", body: "The first harm is ranked strongest for a structural reason rather than a moral one. It does not depend on the man's character, his self-control, or how his household behaves. It depends on whether lawful earning is available, which is a fact about the economy he lives in — and the chapter's opening already reported that some held celibacy better in this age for precisely that reason. A harm nobody can discipline his way out of outranks harms that depend on the person." },
      { title: "Follow what the report at the Balance establishes", body: "And the report is chosen because of the direction it runs. The man arrives with good deeds like mountains — he is not a failure, and the deeds are real. What consumes them is the questioning about the household and about the money: where it came from, where it went. So the danger is not that marriage prevents good deeds. It is that it opens an account whose demands are settled before the deeds are, and the deeds go to meeting them." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note the mirroring of the fifth benefit", body: "The second harm is the fifth benefit stated as a failure, word for word: the claims of the household, patience with their character, bearing what they do. What trains a person who can carry it damages a person who cannot — which is why it sits below the first in the ranking. The first harm is imposed by circumstances; this one is a function of capacity, and a man who knows his own is in a position to predict which side of it he falls on." },
      { title: "Take the last stage seriously", body: "And the third harm has a further stage that is easy to miss, because nothing forbidden appears in it. The household pulls a man toward the world; then the pull becomes enjoyment of what is entirely permitted; then it becomes excess in that enjoyment. No line is crossed at any point you could name. Which is the third class from the book on knowledge appearing again — a good pursued past its measure — and it is the harm least likely to be recognised by the person it is happening to." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Follow the accounting", body: "The accounting is the sharpest reasoning in the book and it turns on a single distinction. Marrying for a child is effort spent seeking a life that is only supposed — it may not happen, and nothing guarantees it. The damage to religion is not supposed; it is immediate and it is happening now. So the man is trading a certain present loss for an uncertain future gain, and the trade fails on those terms alone, before anything is said about whether children are good." },
      { title: "Note the capital and profit image", body: "And the image he closes with is worth holding: religion is the capital and this is the profit. You do not spend capital to chase a return, because without the capital there is nothing to trade with at all. Which reframes the whole weighing — the question is not whether a child is worth having but whether a man may put at risk the one thing every other good depends on, and stated that way the first case answers itself." },
      { title: "See how the second case turns", body: "And then the second case reverses on one fact. Add a strong appetite to the wish for a child, and if the restraint of godfearing is not firm enough that he can trust himself, marriage becomes better. Nothing about the harms has changed — the unlawful earning is still a risk, the household still occupies him. What has changed is that the alternative now carries a danger of its own, and the weighing is between two exposures rather than between an exposure and safety." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note why the division matters more than the content", body: "The chapter's own split into what binds and what is counsel is the useful thing in it, and it is what most often gets lost. Conditions of validity are few, and a contract either meets them or does not. The qualities recommended in a spouse are advice, offered for a particular society, and carry no legal force whatever. Treating the second as though it were the first is the standing error with this material — it turns preferences into requirements and makes people anxious about things nothing depends on." },
      { title: "Say what this edition presents instead", body: "And that is why what is reproduced here is the division and its force rather than the content on either side. The legal half differs between the schools, so no single rendering of it would be accurate. The counsel half was addressed to circumstances a modern reader does not share, and repeating it without that context would present period advice as religious requirement — which is precisely the confusion the chapter's own structure was built to prevent." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what the length of the chapter argues", body: "That the chapter on living together is longer than the deliberation and the contract combined is itself the argument. Most writing about marriage concentrates on whether and to whom — the decisions, which are dramatic and finite. Ghazali gives the majority of his space to the years afterwards, which is where nearly all of a marriage actually is and where almost none of the attention usually goes." },
      { title: "See what setting out both sides does", body: "And laying out duties on both sides in order, rather than treating one party's obligations as the subject, changes what kind of text this is. A chapter listing only what is owed to a husband would be an instrument for one person to use on another. Two sets of claims, set out in parallel, is a description of an arrangement with two parties in it — and it means either of them can read the chapter and find themselves being addressed." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what kind of book this turns out to be", body: "Look at what the reader is actually handed at the end: a list of five benefits, a list of three harms ranked by strength, a note that one item appears on both lists, and two worked examples that come out on opposite sides. That is an instrument, not a verdict. And it is unusual for a book called the etiquette of marriage to end without ever recommending marriage, having instead taught the reader how to run the calculation on himself." },
      { title: "Take the first worked case as the test of the method", body: "And the first case is the evidence that the method is real. A book on the manners of marriage contains a fully argued case concluding that for this man celibacy is better — not as a preliminary objection to be answered, but as the output of the same accounting that produces the opposite result in the next paragraph. An author who had decided the answer in advance would not have left that standing." },
    ],
    closer: [
