...
export const book13Chapters: Chapter[] = [
  makeChapter({
    ...
    moves: [
      ...
      { title: "Follow the ascent", body: "The four standards stack, and each is genuinely higher than the last rather than a restatement of it. Valid means the contract holds — a question a judge can answer. Free of wrongdoing means nobody was harmed, which a valid contract can fail. Excellence means going past what is owed, which a blameless contract does not reach. And the fifth turns the whole apparatus round to ask what the trade has done to the trader. Each chapter opens by naming what the previous one leaves unsettled, which is why the book cannot be read as four ways of saying be honest." },
      { title: "Note where the book ends up", body: "And the destination is worth marking at the start. A book on the etiquette of earning ends not with a rule about transactions but with a man's own religion treated as capital he is spending. The subject shifts from what he owes to other people, which is what the first four chapters are about, to what his occupation is costing him — and the last chapter is addressed to somebody who has done everything right by the earlier standards." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note where the verse places work", body: "The verse is about a day made for livelihood, and Ghazali's observation is that it appears in a list of blessings. That single placement settles the register. Working is not being permitted, or tolerated, or excused as a necessity for people who cannot devote themselves to worship. It is being counted among the things given — which puts earning in the same category as the light and the rain rather than in the category of concessions." },
      { title: "See why the excellences have to come first", body: "And the praise is doing particular work here, because everything after it restricts. Three chapters of prohibitions, disclosure requirements, and warnings follow, and a reader who met them without the opening would reasonably conclude that trade is a hazard best kept small. Establishing first that a day was made for it means the restrictions are the conditions on something good, not the fencing around something suspect." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what a chapter of contract law is doing here", body: "It is worth registering how much technical law sits in a book of the Ihya: sale, usury, forward sales, hire, and two kinds of partnership, each with its conditions. Ghazali is not gesturing at the law and moving on to the inward matter. He gives it properly, because the three chapters that follow all depend on the reader knowing exactly where the legal line falls — you cannot show that a valid contract can still be a wrong unless validity has been specified." },
      { title: "See what the chapter cannot answer", body: "And what it settles is narrow by design: whether the transaction was concluded, and on what terms. That is a question with an answer, decidable by somebody outside the deal. Whether it should have been made, whether anyone was damaged by it, whether the man who made it is better or worse for having made it — none of those is a question this chapter is equipped to ask, which is precisely what the next sentence of the book says out loud." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Take the opening sentence seriously", body: "The sentence the third chapter opens on is the hinge of the book: a dealing the jurist rules valid and concluded may still contain a wrong that exposes the dealer to God's anger. That is a considerable thing to write immediately after a chapter of contract law, and Ghazali gives a technical reason rather than a pious one — not every prohibition invalidates a contract. So the gap between the two standards is not a matter of piety exceeding law. It is a feature of how legal prohibition works." },
      { title: "Note how the standard changes", body: "And the new standard is named precisely: by wrongdoing is meant what harms another. That is a different test entirely from validity, and it is one the parties can apply themselves without a jurist. It also has a clear structure — harm is either general, spreading past the two parties, or particular to the person dealt with — which gives the chapter its two halves and gives a trader two questions he can actually put to a deal he is about to make." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "See why hoarding counts as a general harm", body: "Hoarding is the right first example because nothing about it is a breach of contract. The man owns the food, he is entitled to sell it when he chooses, and every transaction he eventually makes will be valid. What makes it a wrong is that the waiting is aimed at a price, and the price rises because other people need what he is holding. No individual is defrauded; the harm falls on a market, which is exactly the kind of damage validity is blind to." },
      { title: "Note how severe the reports are", body: "And the reports attached are unusually severe for a commercial matter. Forty days of hoarding is not expiated by giving the whole thing away in charity, and the man who does it is described as having quit God and been quit in return. Charity failing as expiation is the striking part: it says the wrong is not a quantity of money wrongly gained that could be given back, but something the transaction did that money cannot undo." },
      { title: "Follow the chain in the second example", body: "And the debased coin shows why the category is called general rather than merely dishonest. If the person paid does not know, he is straightforwardly harmed. If he does know, he takes it anyway — and takes it precisely in order to pass it to somebody else. Either way the coin keeps moving and the damage keeps landing on whoever is holding it when it stops. The harm outlives the transaction that started it, which is the definition the chapter is working with." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note how far the disclosure duty reaches", body: "The disclosure requirement is stated without any of the usual softening: every defect, hidden and apparent, concealed in no part, and it is called obligatory. Note what it does not say. It does not say answer honestly if asked, or refrain from making false claims. It puts the duty on the seller to volunteer what he knows, including the faults a buyer would never find — which reverses the ordinary assumption that a buyer's failure to inspect is a buyer's problem." },
      { title: "See why two names are attached", body: "And when he conceals, two names follow rather than one: he is a wrongdoer, and he is a deceiver. The first attaches to the transaction and could in principle be settled by compensation. The second attaches to him, and describes what he has made of himself by doing it — which is the fifth chapter's subject arriving early, in the middle of a rule about goods." },
      { title: "Take the rule about the caravans", body: "And the rule about meeting the caravans is the sharpest application, because it forbids something that looks like ordinary enterprise. Riding out to buy from people who have just arrived and do not yet know the market price is initiative, and every contract made that way is valid. What makes it a wrong is that the advantage comes entirely from the other party's ignorance of a fact he would have learned within the hour. Truthfulness about the current price is required for the same reason." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Follow the capital and profit image", body: "The image is exact and it is worth not skimming. Justice, he says, is a cause of deliverance only, and it runs in trade as capital runs. Excellence is what wins, and it runs as profit runs. Capital returned is not a loss and it is not a gain either — a man who ends the year with exactly what he started with has kept his money and made nothing. That is the position of a trader who was scrupulously fair to everybody and did nothing beyond it." },
      { title: "See what the conclusion actually asks", body: "And the conclusion lands with an argument aimed at the reader's own trade sense: no merchant on earth would be content to recover his capital and call the year a success. The whole of his working life is organised around the difference between capital and return. Ghazali simply asks why a man who understands that perfectly in his business applies the opposite standard to his religion, where being blameless is treated as the finished article." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what kind of instructions these are", body: "Look at the shape of the four examples. Take less margin than you could. Absorb the loss when dealing with somebody poor. Undo a sale if the other party regrets it. Extend credit to the poor with no intention of pressing for it. Every one of them costs the trader money, none is required by any rule, and none produces a claim on anybody. They are the exact opposite of the disclosure duties, which were obligations owed; these are given away." },
      { title: "Take the cancellation rule as the model", body: "And the reason attached to the cancellation rule is the clearest statement of what excellence means here. Nobody asks to unwind a sale unless he regrets it and it is hurting him — so the request is itself evidence that the deal has landed badly on him. And it does not suit a man, Ghazali says, to be comfortable being the reason somebody is out of pocket. The seller has done nothing wrong and the contract stands. The point is what he is willing to be the cause of." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note the transaction the chapter names", body: "The fifth chapter reframes the whole book as a trade, which is a shrewd thing to do to a merchant. A man whose livelihood occupies him past his return has bought this world with the next — a purchase, made deliberately in the sense that he chose each of the hours that added up to it, and made unwittingly in the sense that he never once saw it presented as a price. Put to a trader in his own vocabulary, it is much harder to wave off than an exhortation about worldliness." },
      { title: "Follow the ordering Mu'adh gives", body: "And the ordering he cites is practical rather than pious, which is why it works. You must have your share of this world — that is granted outright, not conceded. And you need your share of the next more. So begin with the second, because you will pass by the first anyway and arrange it. The claim is about sequence, not about proportion: the world's business will get done whichever order you take them in, and the other business will not." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "See what the second observance claims", body: "The second is the strongest thing in the list and it is easy to read past. A man is to intend, by standing in his craft, the discharge of a communal obligation — because if the trades were abandoned, livelihoods would collapse. Which means his shop is not a permitted activity funding his religion elsewhere. It is a religious obligation being discharged, of the same kind as the cupper and the tailor in the book on knowledge, and the intention is what makes it one." },
      { title: "Note the phrase about the markets", body: "And the third contains the phrase the chapter turns on: the markets of the hereafter are the mosques. It is not an image so much as an instruction about which market a man is trading in at any given hour — and then the fourth immediately refuses to let the two be kept apart, requiring the remembrance of God in the market itself. The point is not to leave one market for the other but to stop treating the hours in the first as time spent outside the trade that matters." },
      { title: "Take the fifth observance's examples", body: "And the fifth is diagnosed by symptoms rather than by amounts. Being the first into the market and the last out of it. Going to sea for the sake of trade. Neither is forbidden, neither is dishonest, and both are what a serious merchant does. What they are evidence of is intensity of appetite for the thing — and appetite, not the trading, is what the observance is measuring." },
    ],
    closer: [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Note what the instruction actually replaces", body: "Do not look to the legal opinions — seek the verdict of your own heart. Said to anybody else that would be an invitation to substitute feeling for law. Said here, after four chapters that gave the law in detail, established that a valid contract can still be a wrong, and set out what goes beyond fairness, it means something narrower: the opinions have already told you where the boundary is, and the question that remains cannot be answered by consulting them again." },
      { title: "See why it is addressed only to oneself", body: "And the closing restriction is doing real work. This is the sixth of seven things by which a trader guards his own religion — counsel for a man deciding about himself. Nothing in it gives anybody standing to assess somebody else's dealings by the verdict of his own heart, which is what the instruction would immediately become if it were let loose. The scruple runs inward only, and the same limit governs the treatment of doubtful things in the book that follows." },
    ],
    closer: [
  ...
  items: [
    {
      ...
      verdicts: [
        ...
        { key: "spread|*", name: "The harm that does not stop", role: "warning", chapterId: 5, body: "His first division concerns wrongs whose harm spreads widely. Both examples work the same way: hoarding food while waiting for the price to rise, and passing a debased coin that the recipient will pass on again. The damage continues beyond the transaction that caused it.", action: "A merchant must learn to recognize the currency, not merely to protect his own interests but to avoid unknowingly giving somebody a bad coin. Competence is required for the other party's protection. Ghazali's fourth rule has the trader absorb a bad coin himself, ending the chain instead of extending it." },
