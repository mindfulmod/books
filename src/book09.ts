...
export const book09Chapters: Chapter[] = [
  ...
  makeChapter({
    ...
    moves: [
      ...
      { title: "Fifth: do not craft your phrasing", body: "Do not turn the prayer into rhymed, worked-up prose. A person asking for help should sound like someone in need, not like someone polishing a performance. Ghazali supports this with a warning against going beyond proper bounds in supplication." },
      { title: "Sixth: pleading, humility, longing and fear", body: "Ghazali gathers verses that describe calling on God with longing, fear, humility, and privacy. He also cites a report connecting a servant's trial with the plea that rises from genuine need." },
  ...
  makeChapter({
    ...
    closer: [
      ...
      { title: "Where the Ihya says this at length", body: "Book 35 argues that using practical means does not remove reliance. A person who takes precautions still relies on the Creator of those precautions rather than on personal planning alone. Book 36 devotes a section to showing that supplication does not contradict contentment and notes that the person at the highest station of contentment prayed constantly." },
    ],
